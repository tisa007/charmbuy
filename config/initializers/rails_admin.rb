...
# RailsAdmin config file. Generated on September 08, 2011 21:04
...
RailsAdmin.config do |config|
  ...
  # config.excluded_models << [Doc, Message, News, Shop, User]
  
  # Add models here if you want to go 'whitelist mode':
  # config.included_models << [Doc, Message, News, Shop, User]
...
#  - belongs_to _id and _type columns are hidden in favor of their associations
...
#  - non-editable associations (polymorphic associations on the has_many/has_one side*) or columns (:id, :created_at, ..) in edit sections
#  - has_many/has_one associations in list section*
...
# *may be supported in the future
  ...
  #   # Found associations: 
  #   field :poster, :belongs_to_association
  #   field :replier, :belongs_to_association
  #   # Found columns:
  #   field :id, :integer
  #   field :body, :text
  #   field :reply, :text
  #   field :is_visible, :boolean
  #   field :is_readed, :boolean
  #   field :is_replied, :boolean
  #   field :poster_id, :integer        # Hidden
  #   field :replier_id, :integer        # Hidden
  #   field :created_at, :datetime
  #   field :updated_at, :datetime
  #   # Sections: 
  #   list do; end
